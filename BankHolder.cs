...
public static class BankData
{
    ...
    public static List<Bank> AllAccounts =>
        typeof(BankData).GetFields(BindingFlags.Static | BindingFlags.Public).Where(f => f.FieldType == typeof(Bank)).Select(f => (Bank)f.GetValue(null)).ToList();
}
